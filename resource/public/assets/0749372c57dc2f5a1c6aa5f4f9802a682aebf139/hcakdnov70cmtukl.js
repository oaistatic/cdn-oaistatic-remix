...
import{c as A,aq as d,y as E,e8 as M,d6 as N,aO as W,N as F,g8 as O,g9 as _,ao as w,bm as B,dB as L,f as R}from"./ltrr4mhf6s4m7a72.js";import{c as H,r as s,j as e,M as a}from"./lklglvrzltpv3f05.js";import{X as q}from"./ntw4l0fkgqdiln85.js";const z={flags:{failwhaleBypassEnabled:!1,sharingEnabled:!1}},V=A()((i,n)=>({...z,updateFlagValue:(h,c)=>{const u=n().flags;i({flags:{...u,[h]:c}})}}));function Q(){const i=H(),n=E(),h=V(o=>o.flags.failwhaleBypassEnabled),[c,u]=s.useState(!1),[T,C]=s.useState(!1),m=M(),g=s.useRef(b[Math.floor(Math.random()*b.length)]),[r,k]=s.useState(!1),[x,p]=s.useState(!1),[f,P]=s.useState(!1),y=N();s.useEffect(()=>{document.title="ChatGPT",C(!0)},[]),s.useEffect(()=>{m(()=>{u(!0)},1e3)},[m]);const v=s.useCallback(async o=>{o.preventDefault();const G=o.target.email.value,I=(await W(async()=>{const{default:l}=await import("./h4h1bynjub33g5q3.js").then(S=>S.i);return{default:l}},__vite__mapDeps([0,1]))).default,j=I(G);p(!0),F.getLoginLink(j).catch(l=>{n.danger(typeof l.message=="string"?l.message:O)}).finally(()=>{p(!1),k(!0)})},[n]);return T?e.jsx(D,{children:e.jsxs("div",{className:"relative flex h-full w-full overflow-hidden",children:[e.jsxs(J,{children:[e.jsx("div",{className:"text-3xl font-semibold",children:e.jsx(a,{...t.title})}),e.jsx("a",{href:"https://share.hsforms.com/13gyIEVN5SrScw-iVvCgIew4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:e.jsx(a,{...t.getNotified})}),e.jsx("div",{className:"flex",children:e.jsx("div",{className:"font-bold",children:g.current.prompt})}),e.jsx("div",{className:"max-w-lg pb-8",children:e.jsx(_,{value:g.current.completion,typing:c,speed:150,chunk:!0})})]}),h&&e.jsx(U,{$show:f,children:e.jsxs("div",{className:"relative m-6 flex w-full flex-col justify-center gap-4 text-gray-800 lg:max-w-sm lg:rounded-lg lg:border lg:p-6",children:[y&&e.jsx("h3",{children:e.jsx(a,{...t.chatGPTPlus})}),!y&&e.jsxs("button",{className:"text-center text-xl font-semibold lg:text-left",onClick:()=>P(o=>!o),children:[e.jsx(a,{...t.chatGPTPlus}),e.jsx(q,{className:w("icon-lg absolute right-0 top-0",!f&&"rotate-180")})]}),e.jsxs("div",{className:"m-auto flex w-full max-w-md flex-col gap-4 rounded-md border p-6 lg:border-0 lg:p-0",children:[!r&&e.jsx("p",{children:e.jsx(a,{...t.addEmail})}),r&&e.jsx("p",{children:e.jsx(a,{...t.allSet,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"})}})}),e.jsxs("form",{onSubmit:v,children:[e.jsx("label",{htmlFor:"email",className:"hidden text-sm font-semibold text-gray-700",children:e.jsx(a,{...t.searchCandidates})}),e.jsxs("div",{className:"mt-1 flex rounded-md shadow-sm",children:[e.jsx("div",{className:"relative flex flex-grow items-stretch focus-within:z-10",children:e.jsx("input",{type:"email",name:"email",id:"email",className:w("form-input block w-full rounded-none rounded-l-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm",{"opacity-50":r}),required:!0,disabled:r,placeholder:i.formatMessage(t.emailPlaceholder)})}),e.jsx(B,{as:"button",color:"primary",className:"rounded-none rounded-r-md",type:"submit",disabled:r,loading:x,children:e.jsx("span",{className:"flex flex-row items-center space-x-1.5",children:r?e.jsxs(e.Fragment,{children:[e.jsx(L,{className:"icon-sm"}),e.jsx(a,{...t.sent})]}):e.jsx(a,{...t.sendLink})})})]})]}),e.jsx("p",{className:"text-sm",children:e.jsx(a,{...t.notSubscriber,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"}),waitlist:o=>e.jsx("a",{href:"https://share.hsforms.com/1_-FpF2GTRJORIb83N3aK7Q4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:o})}})})]})]})})]})}):null}const D=d.div`w-full h-full overflow-auto`,J=d.div`flex w-full max-w-lg mx-auto shrink-0 flex-col gap-6 overflow-auto px-6 pt-20 lg:w-3/5 lg:px-14 lg:pt-32 lg:max-w-none`,U=d.div`absolute bottom-0 w-full lg:w-auto lg:relative flex flex-grow items-center justify-center bg-white rounded-t-xl lg:rounded-none transition-transform
${({$show:i})=>!i&&"translate-y-[calc(100%-71px)] lg:translate-y-0"}`,t=R({title:{id:"CapacityGate.title",defaultMessage:"ChatGPT is at capacity right now"},getNotified:{id:"CapacityGate.getNotified",defaultMessage:"Get notified when we're back"},chatGPTPlus:{id:"CapacityGate.chatGPTPlus",defaultMessage:"ChatGPT Plus subscriber login"},allSet:{id:"CapacityGate.allSet",defaultMessage:"You're all set! If you're a {chatGPTPlus} subscriber, check your email for a login link."},addEmail:{id:"CapacityGate.addEmail",defaultMessage:"Add your email for a personalized login link"},searchCandidates:{id:"CapacityGate.searchCandidates",defaultMessage:"Search candidates"},emailPlaceholder:{id:"CapacityGate.emailPlaceholder",defaultMessage:"Email"},sendLink:{id:"CapacityGate.sendLink",defaultMessage:"Send link"},sent:{id:"CapacityGate.sent",defaultMessage:"Sent!"},notSubscriber:{id:"CapacityGate.notSubscriber",defaultMessage:"Not a {chatGPTPlus} subscriber yet? Join the <waitlist>waitlist</waitlist>."},waitlist:{id:"CapacityGate.waitlist",defaultMessage:"waitlist"}}),b=[{prompt:"Write a poem about the status of ChatGPT.",completion:`ChatGPT, oh ChatGPT
With AI so smart
...
3. ChatGPT can predict the future with 100% accuracy.`}];export{Q as C};
//# sourceMappingURL=hcakdnov70cmtukl.js.map
