import{F as hn,cV as bn,fj as xn,fk as yn,ct as Sn,cX as An,g as Cn,r as i,c2 as I,y as c,au as on,O as wn,X as Tn,bz as Dn,dI as Fn,D as Mn,a1 as R,av as Z,ar as Rn}from"./du9ygo55hccsm0ec.js";import{F as kn,C as _n}from"./ibjw18ivx5tw615x.js";import{u as En}from"./lgn5axrtffpzy508.js";import{J as Pn,w as J}from"./ndpe1ojbx7c3v18s.js";import{k as zn,l as In,m as Ln,a as Nn}from"./ncg1oqtdutoyqpfs.js";import{iu as Un,h as Bn,iv as On,da as Vn,bv as jn}from"./hc0go6t8u8it292j.js";import{b as Q}from"./m7ykldedawewofy8.js";import{b as qn}from"./ot4k89oi9z3cyuwx.js";import{m as Wn}from"./kl23pvq05rxrgvth.js";const Gn="webp",Hn=512,Xn=512,$n="srgb",Kn=3,Yn="uchar",Zn=72,Jn=!1,Qn=8,ne=!1,ee=!1,te="{{.assetPrefix}}/assets/noise-watercolor-m3j88gni.webp",oe={format:Gn,width:Hn,height:Xn,space:$n,channels:Kn,depth:Yn,density:Zn,isProgressive:Jn,paletteBitDepth:Qn,hasProfile:ne,hasAlpha:ee,src:te};var ae=hn,se=bn;function ie(o){return se(o)&&ae(o)}var re=ie,le=xn,ce=Sn,ue=An,de=yn,fe=re,me=Math.max;function ge(o){if(!(o&&o.length))return[];var n=0;return o=le(o,function(t){if(fe(t))return n=me(t.length,n),!0}),de(n,function(t){return ce(o,ue(t))})}var ve=ge,pe=Un,he=ve,be=pe(he),xe=be;const E=Cn(xe),L=240,an=2048,ye=60,N=Math.floor(1e3/ye),sn=new Array(L).fill(0),Se=o=>{const n=zn(o,{bands:L,updateInterval:N,loPass:0,hiPass:400,analyserOptions:{fftSize:an}});return n.length===0?sn:n},U=o=>{const{magnitudes:n,binCount:t,gainMultiplier:s}=o;if(n.length===0)return new Array(t).fill(0);const a=Math.ceil(n.length/t),r=[];for(let u=0;u<n.length;u+=a){const v=Math.min(u+a,n.length),g=n.slice(u,v).sort((d,b)=>d-b),m=Math.floor(g.length/2);let p;g.length%2===0?p=(g[m-1]+g[m])/2:p=g[m],p=Math.abs(p),p*=s;const e=p/(p+1);r.push(e)}return r},rn=(o,n)=>{const t=n.sampleRate,s=o.length,a=n.bandCount,r=n.binCount,u=n.gainMultipliers;if(u.length!==a)throw new Error("gainMultipliers must have length equal to bandCount");const v=s*2,g=t/v,m=o.map((h,l)=>l*g),p=20,e=t/2,d=new Array(a+1).fill(0).map((h,l)=>p*Math.pow(e/p,l/a)),b=new Array(a).fill(null).map(()=>[]);for(let h=0;h<m.length;h+=1)for(let l=0;l<a;l+=1)if(m[h]>=d[l]&&m[h]<d[l+1]){b[l].push(o[h]);break}for(let h=0;h<a;h+=1){const l=b[h],f=u[h];b[h]=U({magnitudes:l,binCount:r,gainMultiplier:f})}return b},nn=60,ln=48e3,Ae=1,Ce=2,we=40,Te=2;function en({time:o,timeConstant:n}){return 1-Math.exp(-o/n)}function tn(o,n){const t=n[1]-n[0];return n[0]+o*t}const P=o=>{if(!Array.isArray(o)||o.length!==2||typeof o[0]!="number"||typeof o[1]!="number")throw new Error("zip failed - received a value that is not a [number, number] tuple")},De=o=>{const{prevAudioData:n,prevCumulativeAudioData:t,deltaTimeS:s,audioDataRaw:a}=o,r=a.map(d=>d*s*nn*Ae),u=en({time:s,timeConstant:Ce}),v=E(n,r).map(d=>(P(d),tn(u,d))),g=a.map(d=>d*s*nn*we),m=E(t,g).map(d=>(P(d),d[0]+d[1])),p=en({time:s,timeConstant:Te}),e=E(t,m).map(d=>(P(d),tn(p,d)));return{audioData:v,cumulativeAudioData:e}},Je=(o,n)=>{const t=Se(o),s=rn(t,{sampleRate:ln,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),a=U({magnitudes:t,binCount:1,gainMultiplier:1});return{bandMagnitudes:s,cumulativeMagnitude:a}};function Fe(o){const n=i.useRef(o);n.current=o;const[t,s]=i.useState(null),a=i.useCallback(r=>{s(r)},[]);return I(()=>{const r=new ResizeObserver(u=>{for(const v of u)n.current(v)});return t&&r.observe(t),()=>{r.disconnect()}},[t]),a}const T=In.createChild("GLCanvas");function Me({className:o,vert:n,frag:t,Behaviors:s,onViewportUpdate:a,onRenderComplete:r,onGlAvailable:u}){const v=i.useRef(null),g=i.useRef(null),[m,p]=i.useState(null),[e,d]=i.useState(),b=i.useRef(Bn(f=>{const{width:x,height:S}=f.contentRect,A=Math.floor(Math.min(x??0,S??0));p(A),a?.({width:A,height:A})},100)),h=Fe(b.current);if(I(()=>{const f=v.current,{width:x,height:S}=f??{};if(f&&m!=null&&x&&S){const A=f.getContext("webgl2",{premultipliedAlpha:!1});A?d(A):T.error("webgl2 context not supported")}},[m]),I(()=>{if(!e)return;const f=e.createProgram(),x=e.createShader(e.VERTEX_SHADER),S=e.createShader(e.FRAGMENT_SHADER);if(!f){T.debug("failed to create program");return}if(!x||!S){T.debug("failed to create shaders",x,S);return}let A="";if(e.shaderSource(x,n),e.compileShader(x),A+=`vertShader:
...
${A}`;g.current=f,T.debug("program created"),u?.(e,f);const F=e.fenceSync(e.SYNC_GPU_COMMANDS_COMPLETE,0);return F&&(e.waitSync(F,0,e.TIMEOUT_IGNORED),r?.()),()=>{T.debug("cleaning up"),g.current=null,e.detachShader(f,x),e.detachShader(f,S),e.deleteShader(x),e.deleteShader(S),e.deleteProgram(f)}},[e,t,n]),m!=null&&e&&v.current){const f=v.current,x=m*window.devicePixelRatio;f.width=x,f.height=x,e.viewport(0,0,x,x)}const l=g.current;return c.jsxs("div",{className:o,ref:h,children:[c.jsx("canvas",{ref:v,style:{width:m??void 0,height:m??void 0}},m),e&&l&&s&&c.jsx(s,{ctx:e,program:l})]})}function Re({ManagerClass:o,textureName:n,textureImage:t,variables:s,className:a,vert:r,frag:u,onViewportUpdate:v,onRenderComplete:g}){const m=i.useRef(void 0),p=i.useCallback((e,d)=>{if(m.current=new o(e,d),t&&n){const b=e.createTexture();e.bindTexture(e.TEXTURE_2D,b),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,t);const h=e.getUniformLocation(d,n);e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,b),e.uniform1i(h,0)}},[o,t,n]);return i.useEffect(()=>{m.current&&m.current.setVariablesAndRender(s)},[s]),c.jsx(Me,{className:a,vert:r,frag:u,onViewportUpdate:v,onRenderComplete:g,onGlAvailable:p,Behaviors:()=>null})}var ke=`#version 300 es
...
}`;class Ee{#o;#i;#n;#a=[];#s={};#e;#t;constructor(n,t){this.#n=n;const s=n.getUniformBlockIndex(t,"MyUniformBlock"),a=n.getActiveUniformBlockParameter(t,s,n.UNIFORM_BLOCK_DATA_SIZE);this.#e=n.createBuffer(),n.bindBuffer(n.UNIFORM_BUFFER,this.#e),n.bufferData(n.UNIFORM_BUFFER,a,n.DYNAMIC_DRAW);const r=0;n.bindBufferBase(n.UNIFORM_BUFFER,r,this.#e),n.uniformBlockBinding(t,s,r);const u=n.getActiveUniformBlockParameter(t,s,n.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES);this.#a=[],this.#s={};for(let v=0;v<u.length;v++){const g=u[v],m=n.getActiveUniform(t,g);if(!m)throw new Error("No uniformInfo for index "+g);let p=m.name;p=p.replace(/\[0\]$/,"");const e=n.getActiveUniforms(t,[g],n.UNIFORM_OFFSET)[0];this.#a.push(p),this.#s[p]=e}this.#t=new ArrayBuffer(a),this.#o=new Float32Array(this.#t),this.#i=new Int32Array(this.#t)}setVariablesAndRender(n){for(const t of this.#a){const[,s]=t.split("."),r=this.#s[t]/4,u=n[s];typeof u=="number"?this.#o[r]=u:typeof u=="boolean"?this.#i[r]=u?1:0:Array.isArray(u)&&this.#o.set(u,r)}this.#n.bindBuffer(this.#n.UNIFORM_BUFFER,this.#e),this.#n.bufferSubData(this.#n.UNIFORM_BUFFER,0,this.#t),this.#n.drawArrays(this.#n.TRIANGLE_STRIP,0,6)}}function y(o){const n=o.replace("#",""),t=parseInt(n.substring(0,2),16)/255,s=parseInt(n.substring(2,4),16)/255,a=parseInt(n.substring(4,6),16)/255;return new Float32Array([t,s,a])}const z={BLUE:{bloopColorMain:y("#DCF7FF"),bloopColorLow:y("#0181FE"),bloopColorMid:y("#A4EFFF"),bloopColorHigh:y("#FFFDEF")},DARK_BLUE:{bloopColorMain:y("#DAF5FF"),bloopColorLow:y("#0066CC"),bloopColorMid:y("#2EC6F5"),bloopColorHigh:y("#72EAF5")},GREYSCALE:{bloopColorMain:y("#D7D7D7"),bloopColorLow:y("#303030"),bloopColorMid:y("#989898"),bloopColorHigh:y("#FFFFFF")},WHITE:{bloopColorMain:y("#FFFFFF"),bloopColorLow:y("#FFFFFF"),bloopColorMid:y("#FFFFFF"),bloopColorHigh:y("#FFFFFF")},BLACK:{bloopColorMain:y("#000000"),bloopColorLow:y("#000000"),bloopColorMid:y("#000000"),bloopColorHigh:y("#000000")}},Pe=o=>{const{resolvedTheme:n}=on();return o?z.BLUE:n==="dark"?z.WHITE:z.BLACK};let cn;if(typeof window<"u"){const o=new window.Image;o.crossOrigin="anonymous",o.src=oe.src,o.onload=()=>{cn=o}}const ze=[300,300],Ie={bands:4,loPass:0,hiPass:400},Le=o=>{const n=t=>{let r=1-Math.max(-100,Math.min(-10,t))*-1/100;return r=Math.sqrt(r),r};return o.map(t=>t===-1/0?0:n(t))};function un(o,n){const[t,s]=i.useState([]),a=i.useRef(void 0);return i.useEffect(()=>{if(!o)return;if(!a.current){const e=new AudioContext,d=e.createMediaElementSource(o),b=e.createAnalyser();d.connect(b),b.connect(e.destination),a.current={audioContext:e,mediaElementAudioSourceNode:d,analyserNode:b}}const{analyserNode:r,audioContext:u}=a.current,v=r?.frequencyBinCount??0,g=new Float32Array(v),p=setInterval(()=>{if(!r)return;r.getFloatFrequencyData(g);let e=g.slice(n.loPass,n.hiPass);const d=Le(e),b=Math.ceil(d.length/n.bands),h=[];for(let l=0;l<n.bands;l++){const f=d.slice(l*b,(l+1)*b).reduce((x,S)=>x+S,0);h.push(f/b)}s(h)},n.updateInterval);return()=>{clearInterval(p),u&&u.close()}},[o,n.bands,n.hiPass,n.loPass,n.updateInterval]),t}const Ne=o=>{const n=un(o,{bands:L,updateInterval:N,loPass:0,hiPass:400,analyserOptions:{fftSize:an}});return n.length===0?sn:n},Ue=(o,n)=>{const t=Ne(o),s=rn(t,{sampleRate:ln,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),a=U({magnitudes:t,binCount:1,gainMultiplier:1});return{bandMagnitudes:s,cumulativeMagnitude:a}},Be=o=>{const[n,t]=i.useState({audioData:[0,0,0,0],cumulativeAudioData:[0,0,0,0]}),s=i.useRef([0,0,0,0]),a=i.useRef(void 0),r=i.useRef(performance.now()),{bandMagnitudes:u,cumulativeMagnitude:v}=Ue(o,{bands:3,bins:1,gainMultipliers:[10,1,1]});s.current=[...u,v].flat();const g=i.useCallback(()=>{const m=performance.now(),p=(m-r.current)/1e3;r.current=m;const e=s.current,{audioData:d,cumulativeAudioData:b}=n,h=De({deltaTimeS:p,audioDataRaw:e,prevAudioData:d,prevCumulativeAudioData:b});t(h)},[n]);return i.useEffect(()=>(a.current||(a.current=window.setInterval(g,N)),()=>{clearInterval(a.current),a.current=void 0}),[g]),n};function dn({url:o,readyToPlay:n}){const t=i.useRef(void 0);return i.useEffect(()=>(t.current||(t.current=document.createElement("audio")),()=>{t.current?.remove()}),[]),i.useEffect(()=>{o&&t.current&&t.current.src!==o&&n&&(t.current.crossOrigin="anonymous",t.current.src=o,t.current.play())},[n,o]),t.current}function Oe({className:o,url:n}){const[t,s]=i.useState(!1),a=dn({url:n,readyToPlay:t}),r=un(a,Ie),u=i.useMemo(()=>[0,0,0,0],[]);return c.jsx(fn,{className:o,url:n,isAdvanced:!1,avgMag:r,cumulativeAudioData:u,onRenderComplete:()=>s(!0)})}function Ve({className:o,url:n}){const[t,s]=i.useState(!1),a=dn({url:n,readyToPlay:t}),r=Be(a),{audioData:u,cumulativeAudioData:v}=r;return c.jsx(fn,{className:o,url:n,isAdvanced:!0,avgMag:u,cumulativeAudioData:v,onRenderComplete:()=>s(!0)})}const fn=({className:o,avgMag:n,cumulativeAudioData:t,isAdvanced:s,onRenderComplete:a})=>{const{resolvedTheme:r}=on(),u=r==="dark",v=i.useMemo(()=>performance.now()/1e3,[]),g=i.useMemo(()=>performance.now()/1e3,[]),[m,p]=i.useState(ze),e=i.useCallback(f=>{p([f.width,f.height])},[]),[d,b]=i.useState(performance.now()/1e3);i.useEffect(()=>{const f=setInterval(()=>{b(performance.now()/1e3)},50);return()=>clearInterval(f)},[]);const h=Pe(s),l={time:d,micLevel:0,stateListen:0,listenTimestamp:0,stateThink:0,thinkTimestamp:0,stateSpeak:1,speakTimestamp:g,readyTimestamp:v,stateHalt:0,haltTimestamp:0,touchDownTimestamp:0,touchUpTimestamp:0,stateFailedToConnect:0,failedToConnectTimestamp:0,avgMag:n,cumulativeAudio:t,isNewBloop:!0,isAdvancedBloop:s,bloopColorMain:Array.from(h.bloopColorMain),bloopColorLow:Array.from(h.bloopColorLow),bloopColorMid:Array.from(h.bloopColorMid),bloopColorHigh:Array.from(h.bloopColorHigh),isDarkMode:u,screenScaleFactor:window.devicePixelRatio,viewport:m,silenceAmount:0,silenceTimestamp:0,fadeBloopWhileListening:!1};return c.jsx(Re,{className:wn("flex items-center justify-center",o),vert:ke,frag:_e,ManagerClass:Ee,variables:l,onViewportUpdate:e,onRenderComplete:a,textureImage:cn,textureName:"uTextureNoise"})},je={offscreenLeft:{x:"-24rem",opacity:0},left:{x:"-12rem",opacity:.5},center:{x:"0",opacity:1},right:{x:"12rem",opacity:.5},offscreenRight:{x:"24rem",opacity:0}};function Qe({conversationId:o,onClose:n,cameFromNux:t=!1}){const{voiceName:s}=On(),a=Vn(),r=Tn(),[u,v]=i.useState(!1),g=Q.getGizmoId(o),[m,p]=i.useState(!1),[e,d]=i.useState(!1);i.useEffect(()=>{requestAnimationFrame(()=>p(!0))},[]);const[b,h]=i.useState(!1),[l,f]=i.useState(null);i.useEffect(()=>{if(a.length>0){const C=a.findIndex(Y=>Y.voice===s);C>=0?f(C):f(2),h(!0)}},[a,s]);const x=i.useMemo(()=>l!=null?(l-2+a.length)%a.length:0,[l,a.length]),S=i.useMemo(()=>l!=null?(l-1+a.length)%a.length:1,[l,a.length]),A=i.useMemo(()=>l!=null?(l+1)%a.length:3,[l,a.length]),F=i.useMemo(()=>l!=null?(l+2)%a.length:4,[l,a.length]),w=a[l??0],B=a[x],O=a[S],V=a[A],j=a[F],M=C=>{f(C)},{stopVoiceMode:q,startVoiceMode:W}=Ln(t),k=Pn(o),{setValue:G}=En(Dn.VoiceName),mn=Nn(C=>C.voiceMode),_=t&&!g?"advanced":mn,gn=i.useCallback(async()=>{d(!t),setTimeout(async()=>{v(!0);const C=l!=null?a[l]?.voice:a[0]?.voice;if(t||C!==s){G(C),await q(),jn(`/?model=${k??J}`);try{await W({conversation_id:void 0,model_slug:k??J,eventSource:"voice_picker",voice_mode:_,voice:C,clientThreadId:Fn(),gizmo_id:Q.getGizmoId(o)})}catch(pn){Mn.addError(`Failed to start voice mode after voice picker: ${pn}`)}}v(!1),n()},300)},[t,o,s,k,n,l,G,W,q,_,a]),vn=()=>{d(!0),setTimeout(n,300)};qn({setSelectedVoiceIndex:f,prevVoiceIndex:S,nextVoiceIndex:A});const[H,X]=i.useState(!1),$=C=>{C==="prev"?M(S):C==="next"&&M(A),X(!0),setTimeout(()=>{X(!1)},175)},K=i.useMemo(()=>({className:"h-max min-h-52 w-max min-w-52",url:w?.preview_url}),[w?.preview_url]);return!b||l==null?c.jsx("div",{className:"fixed left-0 top-0 z-50 flex h-full w-full bg-token-main-surface-primary"}):c.jsxs("div",{className:`fixed left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center bg-token-main-surface-primary transition-opacity duration-300 ${m&&!e?"opacity-100":"opacity-0"}`,children:[c.jsx("h1",{className:"mb-8 mt-36 text-3xl font-semibold",children:c.jsx(R,{id:"2whyE9",defaultMessage:"Choose a voice"})}),c.jsx("div",{className:"flex h-full w-full items-center justify-center",children:w?t&&!g||_==="advanced"?c.jsx(Ve,{...K}):c.jsx(Oe,{...K}):null}),c.jsx("div",{className:"mb-8 flex items-center justify-between text-center",children:c.jsxs("div",{className:"relative flex h-24 w-48",children:[c.jsx(D,{voice:B,variant:"offscreenLeft"},B?.name),c.jsx(D,{voice:O,variant:"left",onClick:()=>M(S)},O?.name),c.jsx("button",{className:`duration-175 absolute -left-4 top-2 z-50 transition-opacity ${H?"opacity-20":"opacity-100"}`,onClick:()=>$("prev"),"aria-label":r.formatMessage({id:"ajuz05",defaultMessage:"Previous voice"}),children:c.jsx(kn,{className:"h-6 w-6 text-token-text-quaternary hover:text-token-text-secondary"})}),c.jsx(D,{voice:w,variant:"center"},w?.name),c.jsx("button",{className:`duration-175 absolute -right-4 top-2 z-50 transition-opacity ${H?"opacity-20":"opacity-100"}`,onClick:()=>$("next"),"aria-label":r.formatMessage({id:"Dr8wrw",defaultMessage:"Next voice"}),children:c.jsx(_n,{className:"h-6 w-6 text-token-text-quaternary hover:text-token-text-secondary"})}),c.jsx(D,{voice:V,variant:"right",onClick:()=>M(A)},V?.name),c.jsx(D,{voice:j,variant:"offscreenRight"},j?.name),c.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-52 transform bg-gradient-to-r from-[var(--main-surface-background)] to-transparent"}),c.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-52 transform bg-gradient-to-l from-[var(--main-surface-background)] to-transparent"}),c.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-96 transform bg-token-main-surface-primary"}),c.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-96 transform bg-token-main-surface-primary"})]})}),c.jsxs("div",{className:"mb-36 flex flex-col space-y-3",children:[c.jsx(Z,{className:"w-52 whitespace-nowrap rounded-full px-20 py-3 font-semibold text-white",onClick:gn,children:u?c.jsx(Rn,{}):w?.voice===s?c.jsx(R,{id:"MyKAgb",defaultMessage:"Done"}):c.jsx(R,{id:"7+3LaJ",defaultMessage:"Start new chat"})}),c.jsx(Z,{className:"w-52 rounded-full px-20 py-3 font-semibold text-black dark:text-white",color:"ghost",onClick:vn,children:c.jsx(R,{id:"dUn4Wd",defaultMessage:"Cancel"})})]})]})}function D({voice:o,variant:n,onClick:t}){return c.jsxs(Wn.button,{onClick:t,className:"absolute flex w-48 select-none flex-col items-center justify-center",variants:je,animate:n,initial:n,transition:{duration:.25,ease:"easeInOut"},children:[c.jsx("p",{className:`text-lg ${n==="center"?"font-semibold":""}`,children:o?.name}),c.jsx("p",{className:"text-sm text-gray-600 dark:text-[var(--text-secondary)]",children:o?.description})]})}export{N as U,Qe as V,Pe as a,Re as b,_e as c,Ee as d,oe as n,De as s,Je as u,ke as v};
//# sourceMappingURL=bq1bzivum2ma5t2o.js.map
