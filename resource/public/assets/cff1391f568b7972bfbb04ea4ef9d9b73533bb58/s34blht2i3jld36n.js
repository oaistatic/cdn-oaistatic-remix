import{a6 as e,ar as U,aj as S,r as p,ak as Y,a2 as Q,d7 as Z,c3 as k,f6 as d,J as ee,aL as E,aH as r,bJ as te,a$ as O}from"./l3hptpare9m1mqfv.js";import{j as ae,k as se,fs as re,d as oe,c3 as B,dV as w,I as ne,ft as b}from"./c7sgref9mfwezh7s.js";import{Y as H}from"./mzkxlhrlmxhntkvn.js";import{A as ie}from"./gcp5u7fnruissmb7.js";import{H as le,V as ce,a_ as de,r as ue}from"./km9gro7xi1t4gs2t.js";import{F as me,a as L,b as N}from"./by9st6otesu1re9k.js";import{a as pe,b as he}from"./b8122jhzfygyzjt9.js";import"./fsddy3bxlesj6ecw.js";import"./g3xwycjx8gd49erj.js";import"./ds7myuf7nkx8b20x.js";import"./ev3ca23urw2rf3h9.js";import"./dpmpp4vjdzk6xdj4.js";import"./bkgevi7dwlpkqxzf.js";import"./i4jzjalmx9h3noc6.js";import"./mh08vel4sd7gl5e4.js";import"./o8pwa9djmd3woe3v.js";import"./ighnjpo7t7h4h60s.js";import"./be8bofiqdkk45zw7.js";import"./he20qiwgsftwhtr2.js";import"./gef2pkbm9t7u9jaf.js";import"./ma543wl1emaceytt.js";import"./j6n14by4mv1mn19j.js";import"./mzxkdr9pas3hg58p.js";import"./fg34biyrlirgihlj.js";import"./dl7ede68b0iso9ei.js";import"./lqjdha68cqgoq5qr.js";import"./0odnh5vt1ryeof4u.js";import"./d436fvfnswrdeh45.js";function xe({className:a,children:i,...o}){return e.jsx(ae,{className:a,...o,children:i})}const fe=({value:a,className:i,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",i),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...i})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...i}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const i=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(J[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:i.formatMessage(I.examples)}),J.map((l,t)=>e.jsx("option",{value:t,children:i.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
